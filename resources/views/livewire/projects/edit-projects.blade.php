        ...
        <form wire:submit.prevent="editProject" class="border-t my-4">
            <div class="flex gap-2 mt-5">
                ...
                <div class="flex w-full gap-2">
                    ...
                    <x-select label="Seleziona Approvazione" id="is_approved" shadow placeholder="Seleziona..."
                        wire:model.live="is_approved" :options="$typesApproved" option-label="name" option-value="id" />
                </div>
            </div>
            <div class="mt-5">
