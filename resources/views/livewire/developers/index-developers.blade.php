    ...
    <div class="bg-white rounded-lg border border-gray-300 h-full overflow-y-auto p-6">
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex justify-between items-center">
                ...
                <x-button icon="plus" black label="Aggiungi Membro" class="font-bold w-[200px] h-[32px]" wire:navigate
                ...
                <tbody class="bg-white divide-y text-sm divide-gray-200">
                    ...
                    <tr wire:key="developer-{{ $developer->id }}-{{ str()->random(10) }}">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            @if ($developer->type)
                            <div
                                class="rounded-full font-medium text-sm px-4 py-1 {{ $this->getColorType($developer->type) }}">
