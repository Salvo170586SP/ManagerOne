<div class="-mt-2">
    ...
    <div class="flex gap-3 mx-auto text-black">
        <div class="w-[500px] {{-- h-[600px] --}} bg-white p-5 rounded-lg border border-gray-300">
            ...
            <div class="w-full  flex flex-col items-start justify-start">
                ...
                <div class="w-full flex items-center justify-between border-t border-gray-300 pt-3">
                    <div>
                        ...
                        <div class="flex items-center bg-green-600 text-white rounded-full px-5 py-1">
                            <div class="font-bold">
                                Pagata
                            </div>
                        </div>
                        @else
                        <div class="flex items-center bg-red-600 rounded-full text-white px-5 py-1">
                            <div class="font-bold">
                                Non Pagata
                            </div>
                        </div>
