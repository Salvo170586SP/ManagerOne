                    ...
                    <x-card wire::key="team-{{ $team->id }}-{{ str()->random(10) }}" color="blue" shadow="false"
                        ...
                        <div class="flex justify-between items-center mb-5">
                            ...
                            <div class="flex justify-end items-center">
                                @role('super_admin')
                                    <x-button flat blue icon="eye"
                                        x-on:click="$openModal('openModalDetail-{{ $team->id }}')" />
                                            ...
                                            <div class="flex gap-2">
                                                <div class="border rounded-lg p-2">
                                                    @foreach ($team->pms as $pm)
                                                        <div wire::key="pmTeam-{{ $pm->id }}-{{ str()->random(10) }}"
                                                            class="me-3">
                                                            <div class="text-sm font-bold">
                                                                Project Manager
                                                            </div>
                                                            <div class="flex justify-between items-center mt-2">
                                                                ...
                                                                <div class="ms-2">
                                                                    @role('super_admin')
                                                                        ...
                                                                        <x-modal name="pmTeam-{{ $pm->id }}"
                                                                            blur="sm" align="center">
                                                                            <x-card shadow="xl">
                                                                                <div
                                    ...
                                    <x-button flat red icon="trash"
                                        x-on:click="$openModal('team-{{ $team->id }}')" />
