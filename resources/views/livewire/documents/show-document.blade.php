    ...
    <div class="bg-white rounded h-[calc(100vh-13rem)] overflow-y-auto p-6">
        <div class="flex justify-between items-center">
            ...
            <div class="flex justify-between items-center">
                ...
                <x-button icon="arrow-left" label="Torna all'Archivio" black wire:navigate href="/documents" class="font-bold w-[200px] h-[32px]"/>
            </div>
        </div>
        ...
        <div class="flex flex-wrap gap-3 mt-8">
            @forelse ($invoices as $invoice)
                <x-card shadow class="border w-[300px] bg-blue-50/50">
                    ...
                    <div class="flex items-center justify-center h-[100px] border-b ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-21">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
                        </svg>
                    </div>
            ...
            @empty
                <div class="w-full flex flex-col items-center font-medium text-sm text-gray-500 py-10">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-21 mt-5">
