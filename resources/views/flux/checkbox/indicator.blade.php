...
$classes = Flux::classes()
    ...
    ->add([
        'bg-white',
        '[ui-checkbox[data-checked]_&]:bg-black', // sfondo nero se selezionato
        '[ui-checkbox[data-checked]_&]:text-white', // testo bianco se selezionato
        '[ui-checkbox[data-indeterminate]_&]:bg-[var(--color-accent)]',
        'hover:[ui-checkbox[data-checked]_&]:bg-black',
        'focus:[ui-checkbox[data-checked]_&]:bg-black',
    ])
    ;
@endphp
